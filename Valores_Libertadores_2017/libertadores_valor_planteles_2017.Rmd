...
menu: ''
share: yes
slug: libertadores_valor_planteles_2017
tags:
- Copa Libertadores
- Clasificados
- Valor planteles
...
Bien, nos desviamos un poco de la variable plata en el úlimo análisis, pero para finalizar el post retomaremos el tema incluyendo el valor en el mercado de las ligas completas, es decir considerando todos los planteles de la división principal de cada país. También los datos fueron descargados del sitio Transfermakt.com. A continuación un boxplot con todas las ligas excepto Paraguay y Bolivia cuyos datos no están disponibles. Se agrega el promedio con puntos rojos.
...
#### Conclusiones
En resumen, hemos incorporado la variable plata a la discusión, encontrando interesantes relaciones con el rendimiento internacional, al menos para esta edición de la Copa Libertadores. Cuando los comentaristas deportivos y los hinchas en general traten de buscar una causa respecto al "mal rendimiento internacional" de los equipos chilenos, e #DatoFútbol creemos que deberían darle un peso importante al valor económico de los planteles. 

Deportes Iquique estuvo cerca, enfrentando a 2 equipos de su mismo nivel económico. Si hubiese clasificado habría sido solo una de las 3 excepciones, a costa de Guaraní que en su defecto no habría clasificado. Por su parte, Universidad Católica tenía poca chances de pasar a octavos mirando la diferencia entre el valor de su plantilla y la de sus rivales (diferencia mayor a 20 millones de euros con Atlético Paranaense, su rival más cercano).
